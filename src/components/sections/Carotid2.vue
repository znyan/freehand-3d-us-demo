...
export default {
  ...
  setup() {
    ...
    const initRealVolume = () => {
      const container = document.getElementById('vtk-container-carotid-2-real');
      ...
      reader.setUrl(`/freehand-3d-us-demo/public/result/carotid_665/real_volume.vti`, { loadData: true }).then(() => {
    ...
    const initFakeVolume = () => {
      const container = document.getElementById('vtk-container-carotid-2-fake');
      const fullScreenRenderWindow = vtkFullScreenRenderWindow.newInstance({
        container: container,
        background: [0, 0, 0],
      });
      ...
      reader.setUrl(`/freehand-3d-us-demo/public/result/carotid_665/fake_volume.vti`, { loadData: true }).then(() => {
          const data = reader.getOutputData();
          const dataRange = data.getPointData().getScalars().getRange();
          const firstIsoValue = (dataRange[0] + dataRange[1]) / 3;
    ...
    onMounted(async () => {
      try {
        // imu
        const jsonResponse = await fetch('/freehand-3d-us-demo/result/carotid_665/imu_data.json');
...
<template>
  <div>
    ...
    <el-row justify="center">
      <h1 class="section-title">示例6（颈动脉）</h1>
    </el-row>
    ...
    <el-row justify="center" class="equal-height-row" gutter="20">
        ...
        <div class="element-container-2">
          <el-container class="video-container">
            <video controls muted preload autoplay loop playsinline>
              <source src="/result/carotid_665/video.webm" type="video/mp4">
            </video>
          </el-container>
        </div>
      </el-col>
      ...
      <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
        ...
        <div class="element-container-2">
          <div id="vtk-container-carotid-2-real"></div>
        </div>
      </el-col>
      ...
      <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
        ...
        <div class="element-container-2">
          <div id="vtk-container-carotid-2-fake"></div>
        </div>
      </el-col>
...
#vtk-container-carotid-2-fake, 
#vtk-container-carotid-2-real {
  height: 260px;
}
